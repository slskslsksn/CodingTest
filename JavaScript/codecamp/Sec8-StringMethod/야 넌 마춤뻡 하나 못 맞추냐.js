...
function solution(str) {
  if (str.includes('q') || str.includes('Q')) console.log(str.replaceAll('q', 'a').replaceAll('Q', 'A'));
  else console.log(-1)
}

solution("It works, I don't know why.");
// -1
solution('Qre you sleeping? Yes, now shut up. I know how to fix thqt bug on line 255.');
